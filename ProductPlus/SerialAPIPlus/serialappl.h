...
typedef enum _E_SERIALAPI_SET_LEARN_MODE_
{
  ...
  SERIALPI_SET_LEARN_MODE_LEARN_PLUS_LEARN_MODE_DISABLE       = LEARN_MODE_DISABLE + SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET,
  SERIALPI_SET_LEARN_MODE_LEARN_PLUS_LEARN_MODE_INCLUSION     = LEARN_MODE_INCLUSION + SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET,
  SERIALPI_SET_LEARN_MODE_LEARN_PLUS_LEARN_MODE_EXCLUSION     = LEARN_MODE_EXCLUSION + SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET,
  SERIALPI_SET_LEARN_MODE_LEARN_PLUS_LEARN_MODE_EXCLUSION_NWE = LEARN_MODE_EXCLUSION_NWE + SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET,
  SERIALPI_SET_LEARN_MODE_LEARN_PLUS_MAX                      = SERIALPI_SET_LEARN_MODE_LEARN_PLUS_LEARN_MODE_EXCLUSION_NWE
