...
@return
*/
static void  wkuppoll_old_sts_cb(appl_layer_ctx_t *appl_ctx, int8_t tx_sts, void *user_prm, uint8_t node_id)
{
...
@return
*/
static void  wkuppoll_probe_cb(appl_layer_ctx_t *appl_ctx, int8_t tx_sts, void *user_prm, uint8_t node_id)
{
    wupoll_ctx_t        *wupoll_ctx = (wupoll_ctx_t *)user_prm;
    wupoll_evt_msg_t    msg;
