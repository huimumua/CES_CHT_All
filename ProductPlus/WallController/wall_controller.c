...
//@ [cmdClassListNonSecureNotIncluded]
{
  ...
  COMMAND_CLASS_MARK,
  /*
   * COMMAND_CLASS_MARK is a marker indicating that classes before this marker
   * are supporting classes and those after are controlling classes. See more at
   * page 5-6 in Z-Wave Command Class Specification, A-M, version 5.0.
   *
   * The following classes are those which this device will use when initiating
   * communication to other Z-Wave devices.
   */
...
static const uint8_t GroupName[]       = "Lifeline";
static const uint8_t EP1LifelineName[] = "EP1 switch";
static const uint8_t EP2LifelineName[] = "EP2 NOT USED";
static const uint8_t EP3LifelineName[] = "EP3 switch";
static const uint8_t EP4LifelineName[] = "EP4 switch";
...
ApplicationInitSW(ZW_NVM_STATUS nvmStatus)
{
  ...
  AGI_LifeLineGroupSetup(agiTableLifeLineEP1_2_3_4, (sizeof(agiTableLifeLineEP1_2_3_4)/sizeof(CMD_CLASS_GRP)), EP1LifelineName, ENDPOINT_1);
  AGI_ResourceGroupSetup(&agiTableEndpoint1Groups, (sizeof(agiTableEndpoint1Groups)/sizeof(AGI_GROUP)), ENDPOINT_1);
  AGI_LifeLineGroupSetup(agiTableLifeLineEP1_2_3_4, (sizeof(agiTableLifeLineEP1_2_3_4)/sizeof(CMD_CLASS_GRP)), EP2LifelineName, ENDPOINT_2);
  AGI_ResourceGroupSetup(&agiTableEndpoint2Groups, (sizeof(agiTableEndpoint2Groups)/sizeof(AGI_GROUP)), ENDPOINT_2);
  AGI_LifeLineGroupSetup(agiTableLifeLineEP1_2_3_4, (sizeof(agiTableLifeLineEP1_2_3_4)/sizeof(CMD_CLASS_GRP)), EP3LifelineName, ENDPOINT_3);
  AGI_ResourceGroupSetup(&agiTableEndpoint3Groups, (sizeof(agiTableEndpoint3Groups)/sizeof(AGI_GROUP)), ENDPOINT_3);
  AGI_LifeLineGroupSetup(agiTableLifeLineEP1_2_3_4, (sizeof(agiTableLifeLineEP1_2_3_4)/sizeof(CMD_CLASS_GRP)), EP4LifelineName, ENDPOINT_4);
 ...
 */
void
LearnCompleted (uint8_t bNodeID)
{
...
//@ [DEVICE_RESET_LOCALLY_TX]
      ...
      if (EVENT_KEY_B2_PRESS == event)
      {
        ...
        ZCB_EventEnqueue(EVENT_APP_CENTRAL_SCENE_JOB);
    ...
    case STATE_APP_LEARN_MODE:
      ...
      if(EVENT_KEY_B1_TRIPLE_PRESS == event)
      {
        ZW_DEBUG_MYPRODUCT_SEND_STR("Disable LEARNMODE ");
    ...
    case STATE_APP_TRANSMIT_DATA:
      ...
      if((EVENT_KEY_B2_DOWN == event) || (EVENT_KEY_B2_HELD == event) || (EVENT_KEY_B2_UP == event) ||
         (EVENT_KEY_B4_DOWN == event) || (EVENT_KEY_B4_HELD == event) || (EVENT_KEY_B4_UP == event) ||
         (EVENT_KEY_B6_DOWN == event) || (EVENT_KEY_B6_HELD == event) || (EVENT_KEY_B6_UP == event))
      {
        /* Allready handling an active unsolicited event. Postpone current event*/
        ZCB_EventSchedulerEventAdd(event);
        break;
      }
        ...
        uint8_t nextActiveButton)
{
  ...
  {
    ZCB_EventEnqueue(EVENT_APP_CC_BASIC_JOB);
  ...
  else if (KEY_HOLD == keyEventGlobal)
  {
    ...
    ZCB_EventEnqueue(EVENT_APP_CC_SWITCH_MULTILEVEL_JOB);
...
static void InitiateCentralSceneTX(uint8_t keyAttribute, uint8_t sceneNumber)
{
  ...
  JOB_STATUS jobStatus = CommandClassCentralSceneNotificationTransmit(
          &lifelineProfile,
          sceneNumber, /*sceneNumber and endpoint is the same!*/
          keyAttribute,
          sceneNumber,
