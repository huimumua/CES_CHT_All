...
public class RecentlyAdapter extends RecyclerView.Adapter<RecentlyAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if ("BULB".equals(deviceType)) {
            holder.device_img.setBackgroundResource(R.drawable.ic_grid_blub);
            holder.device_toggle_state.setVisibility(View.VISIBLE);
        } else if ("PLUG".equals(deviceType)) {
            holder.device_img.setBackgroundResource(R.drawable.ic_grid_swith_on);
            holder.device_toggle_state.setVisibility(View.VISIBLE);
        } else if ("WALLMOTE".equals(deviceType)) {
            holder.device_img.setBackgroundResource(R.drawable.ic_grid_wallmote);
            holder.device_toggle_state.setVisibility(View.INVISIBLE);
        } else if ("EXTENDER".equals(deviceType)) {
            holder.device_img.setBackgroundResource(R.drawable.ic_grid_square);
            holder.device_toggle_state.setVisibility(View.INVISIBLE);
