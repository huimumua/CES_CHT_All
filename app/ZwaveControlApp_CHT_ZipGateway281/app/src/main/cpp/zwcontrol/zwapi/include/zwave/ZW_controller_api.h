 ...
 *
 * Last Changed By:  $Author: aes $
 * Revision:         $Revision: 21224 $
 * Last Changed:     $Date: 2011-08-10 20:21:21 +0800 (Wed, 10 Aug 2011) $
 *
 ****************************************************************************/
...
/*These two codes are used by the Z/IP router*/
#define ADD_NODE_STATUS_DONE_SECURE          8
...
/*These two codes are used by the Z/IP router*/
#define LEARN_MODE_SECURITY_FAILED          ADD_NODE_STATUS_SECURITY_FAILED
#define LEARN_MODE_DONE_SECURE              ADD_NODE_STATUS_DONE_SECURE
...
#define ZW_GET_ROUTING_INFO_ANY            RF_OPTION_SPEED_NONE
#define ZW_GET_ROUTING_INFO_9600           RF_OPTION_SPEED_9600
#define ZW_GET_ROUTING_INFO_40K            RF_OPTION_SPEED_40K
#define ZW_GET_ROUTING_INFO_100K           RF_OPTION_SPEED_100K
#define ZW_GET_ROUTING_INFO_SPEED_MASK     RF_OPTION_SPEED_MASK
...
/*========================   ZW_GET_ROUTING_MAX   ============================
**
**  Get the maximum number of route tries which should be done before failing
**  or resorting to explore if this is specified.
**
**  Side effects:
**
**--------------------------------------------------------------------------*/
#define ZW_GET_ROUTING_MAX() ZW_GetRoutingMAX()
