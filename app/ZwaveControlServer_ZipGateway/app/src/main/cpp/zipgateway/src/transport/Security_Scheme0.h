 ...
 * @param enc_data pointer to the encryted data, enc_data is modified by this function an will contain a pater of the decrypted message when this function returns
 * @param enc_data_length Length of the encrypted data.
 * @param dec_message The descrypted message is written into this pointer
 * @return The length of the decryped message, 0 if decryption fails.
 *
 */
...
/**
 * Initialize the security transport layer, this resets all sessions and stops all timers
 */
void sec0_init();
