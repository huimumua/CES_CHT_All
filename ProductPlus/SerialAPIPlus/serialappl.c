    ...
    case stateFrameParse :
    {
      ...
      switch (serFrameCmd)
      {
        ...
        case FUNC_ID_ZW_SET_LEARN_MODE:
          ...
          {
            /* HOST want to use ctrl_learn for inclusion/exclusion */
            ...
            StartLearnModeNow((SERIALPI_SET_LEARN_MODE_LEARN_PLUS_MAX >= serFrameDataPtr[0]) ?
                               serFrameDataPtr[0] - SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET :
                               LEARN_MODE_DISABLE);
          }
#else
          ZW_SET_LEARN_MODE(serFrameDataPtr[0], (serFrameDataPtr[1] != 0) ? ZCB_ComplHandler_ZW_NodeManagement : NULL);
          ...
          if (SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET > serFrameDataPtr[0])
          {
            ...
            ZW_SetLearnMode(serFrameDataPtr[0],
                            (serFrameDataPtr[1] != 0)
                             ?
                              ZCB_ComplHandler_ZW_SetLearnMode
                             :
          ...
          {
            /* HOST want to use slave_learn_plus for inclusion/exclusion */
            /* We need to substract the SERIALPI_SET_LEARN_MODE_LEARN_PLUS_OFFSET to get: */
            /* LEARN_MODE_DISABLE =  0,      Disable learn process */
            /* LEARN_MODE_INCLUSION  = 1,    Enable the learn process to do an inclusion */
            /* LEARN_MODE_EXCLUSION  = 2,    Enable the learn process to do an exclusion */
          ...
          if ((FRAME_LENGTH_MIN + 1) <= serFrameLen)
          {
            ...
            switch (serFrameDataPtr[0])
            {
              ...
              case SERIAL_API_SETUP_CMD_SUPPORTED:
                ...
                /* ZW->HOST: SERIAL_API_SETUP_CMD_SUPPORTED | SERIAL_API_SETUP_CMD_TX_STATUS_REPORT */
#ifndef slave_routing
              ...
              case SERIAL_API_SETUP_CMD_TX_POWERLEVEL_SET:
                 ...
                 * ZW->HOST: SERIAL_API_SETUP_CMD_TX_POWER | retVal */
                if ((FRAME_LENGTH_MIN + 7) <= serFrameLen)
                {
              ...
              case SERIAL_API_SETUP_CMD_TX_POWERLEVEL_GET:
                /* HOST->ZW: SERIAL_API_SETUP_CMD_TX_POWER
                 * ZW->HOST: SERIAL_API_SETUP_CMD_TX_POWER | config |
...
#if SUPPORT_ZW_SET_LEARN_MODE
  ZCB_ComplHandler_ZW_SetLearnMode(ASSIGN_COMPLETE, bNodeID);
#endif
