...
public class RemoveDeviceActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStatus.setText("Please tap the device's action button...");
    ...
    public Runnable bindzwaveservice = new Runnable() {
        ...
        public void run() {
            ...
            Intent serviceIntent = new Intent(RemoveDeviceActivity.this, ZwaveControlService.class);
