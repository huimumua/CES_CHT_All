package com.askey.iotcontrol.bean;
...
public class DeviceList {
    ...
    public static class NodeInfoList implements Parcelable {
        ...
        public static class EndPoint implements Parcelable{
            ...
            @SerializedName("Endpoint interface id")
            public Integer endPointInterfaceId;
            ...
            protected EndPoint(Parcel in) {
                ...
                endPointInterfaceId = in.readInt();
            ...
            public void setEndPointInterfaceId(int endPointInterfaceId) {
                this.endPointInterfaceId = endPointInterfaceId;
            }

            public int getEndPointInterfaceId() {
                return  endPointInterfaceId;
            }
            ...
            public void writeToParcel(Parcel parcel, int i) {
                ...
                parcel.writeInt(endPointId);
                parcel.writeInt(endPointInterfaceId);
