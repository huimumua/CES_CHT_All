...
#define AGITABLE_LIFELINE_GROUP_EP1_2_3 {COMMAND_CLASS_NOTIFICATION_V3, NOTIFICATION_REPORT_V3}
...
#define  AGITABLE_ROOTDEVICE_GROUPS \
 ...
 {ASSOCIATION_GROUP_INFO_REPORT_PROFILE_NOTIFICATION, NOTIFICATION_REPORT_POWER_MANAGEMENT_V4, {COMMAND_CLASS_NOTIFICATION_V3, NOTIFICATION_REPORT_V3},"alarm EP 3"}
...
#define EP3_LIFELINE_NAME {'E','P',' ','3',' ','d','i','m','m','e','r','\0'}
