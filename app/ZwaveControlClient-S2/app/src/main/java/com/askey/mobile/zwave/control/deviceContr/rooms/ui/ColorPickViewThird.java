...
public class ColorPickViewThird extends ViewGroup {
    //圆形半径
    private int mRadius;
    //开始角度
...
//    private static final float DISTANCE_FROM_CENTER = 2 / 3f;
     ...
     * @param attrs
     */
    public ColorPickViewThird(Context context, AttributeSet attrs) {
        super(context, attrs);
        setPadding(0, 0, 0, 0);
        mContext = context;
    }
     ...
     * @param context
     */
    public ColorPickViewThird(Context context) {
        super(context);
        setPadding(0, 0, 0, 0);
        mContext = context;
    }
    ...
    public void refresh() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            // 布局child view
            if (i == (childCount - 1)) {
                child.layout(mRadius - (int) (mRadius * ITEM_DIMENSION), mRadius - (int) (mRadius * ITEM_DIMENSION),
                        mRadius + (int) (mRadius * ITEM_DIMENSION), mRadius + (int) (mRadius * ITEM_DIMENSION));
            } else {
                child.layout(x, y,
