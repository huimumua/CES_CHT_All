...
void test_kex_joining_node_state_machine() {
  ...
  s2_joining_context.peer.class_id = 0xFF;
  ...
  s2_including_context.peer.class_id = 0xFF;
  ...
  s2_inclusion_challenge_response(&s2_including_context, 1, m_test_public_key_b);
  s2_inclusion_challenge_response(&s2_joining_context, 1,m_test_public_key_a);
  ...
  s2_including_context.peer.class_id = 0x00;
  s2_inclusion_post_event(&s2_including_context);
  ...
  s2_joining_context.peer.class_id = 0x00;
  s2_inclusion_post_event(&s2_joining_context);
  ...
  s2_including_context.peer.class_id = 0x01;
  s2_inclusion_post_event(&s2_including_context);
  ...
  TEST_ASSERT_EQUAL_UINT8_ARRAY(p_network_key_joining_update_temp_key_mock->actual_arg[1].p,
                                p_network_key_including_update_temp_key_mock->actual_arg[1].p,
                                16);
