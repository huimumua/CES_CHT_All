...
#define     CB_TYPE_NET_ERR             11  ///< Network error callback
...
//#define ZWNET_ZIPGW_VER_EP_NIF          0x023B      ///< Testing
...
typedef enum
{
    ...
    MC_SUBSTA_EP_CNT,           ///< Getting total number of endpoints
    MC_SUBSTA_EP_CAP,           ///< Getting endpoint capabilities
    MC_SUBSTA_AGGR_EP_MBR,      ///< Getting aggregated endpoint members
    ...
    COLOR_SUBSTA_DATA,          ///< Getting color switch level
    COLOR_SUBSTA_SUPP,          ///< Getting supported color switch
    ...
    THRMO_SETP_SUBSTA_RANGE,    ///< Getting supported thermostat setpoint temparature range
	...
	ALRM_SNSR_SUBSTA_DATA,      ///< Getting alarm sensor readings for each type
 	...
 	BAR_OPRT_SUBSTA_DATA,       ///< Getting barrier operator state
 	BAR_OPRT_SUBSTA_SUPP,       ///< Getting  supported barrier operator notification subsystem

    VER_SUBSTA_CC,              ///< Getting command classs version
    VER_SUBSTA_DEVICE,          ///< Getting device version

    CSC_SUBSTA_CFG,             ///< Set Central Scene Controller configuration
    CSC_SUBSTA_SUPP,            ///< Getting supported Central Scene Controller scene and key attributes

    NAMELOC_SUBSTA_NAME,        ///< Getting name
    NAMELOC_SUBSTA_LOC,         ///< Getting location
...
/** Pre-kit whitelist context */
typedef struct
{
	wl_info_fn  info_cb;	    /**< Callback to report whitelist entry information*/
    wl_list_fn  list_cb;        /**< Callback to report whitelist DSK list*/
    void        *info_usr_ctx;  /**< Whitelist entry information callback user context*/
    void        *list_usr_ctx;  /**< Whitelist DSK list callback user context*/
} wl_ctx_t;
...
typedef struct _zwnet
{
    ...
    wl_ctx_t            wl_ctx;             /**< Pre-kit whitelist context*/
