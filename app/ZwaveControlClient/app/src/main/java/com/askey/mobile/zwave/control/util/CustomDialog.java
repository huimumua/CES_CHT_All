...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		public CustomDialog create() {
			...
			View layout = inflater.inflate(R.layout.dialog_retry_layout, null);
			...
			// set the go wan button
			if (neutralButtonText != null) {
				((Button) layout.findViewById(R.id.go_wan))
				...
				// if no confirm button just set the visibility to GONE
				layout.findViewById(R.id.go_wan).setVisibility(
						View.GONE);
			}
