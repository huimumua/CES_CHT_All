 ...
 * @param bAdding boolean should be true if the controller is still adding node
 */
 ...
 */
void rd_set_ep_name(rd_ep_database_entry_t* ep,char* name,u8_t size);
void rd_set_ep_location(rd_ep_database_entry_t* ep,char* name,u8_t size);
