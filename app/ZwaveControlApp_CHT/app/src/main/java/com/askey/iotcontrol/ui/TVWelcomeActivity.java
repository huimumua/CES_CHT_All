...
public class TVWelcomeActivity extends BaseActivity{

    private static String LOG_TAG = TVWelcomeActivity.class.getSimpleName();
    ...
    private boolean mqttBrokerFlag = false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Intent MqttIntent = new Intent(TVWelcomeActivity.this, MQTTBroker.class);
        if (!isServiceRunning(mContext,MQTTBroker.class)){
            Log.i(LOG_TAG,"No MQTT service! Launch it!!!");
            mqttBrokerFlag = true;
