...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initFragment() {
        ...
        fragmentList.add(new SignUpOneFragment());
        fragmentList.add(new SignUpSecondFragment());
        fragmentList.add(new SignUpThirdFragment());
    ...
    private void initView() {
        ...
        layout = (LinearLayout) findViewById(R.id.activity_sign_up_home);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_right:
                ...
                break;
            case R.id.activity_sign_up_home:
    ...
    public void setRightButtonStatus(boolean status) {
        right.setClickable(status);
    }
}
