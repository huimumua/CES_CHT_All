/**
 * @file CommandClassAssociation.c
 * @brief Command Class Association.
 * @author Thomas Roll
 * @author Christian Salmony Olsen
 * @copyright Copyright (c) 2001-2016
 * Sigma Designs, Inc.
 * All Rights Reserved
 * @details Handles commands in the Association Command Class.
 */
...
/*
BYTE
CommandClassAssociationVersionGet(void)
{
