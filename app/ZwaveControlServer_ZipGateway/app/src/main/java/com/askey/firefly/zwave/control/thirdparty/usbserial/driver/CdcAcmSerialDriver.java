package com.askey.firefly.zwave.control.thirdparty.usbserial.driver;
...
import com.askey.firefly.zwave.control.thirdparty.usbserial.util.HexDump;
...
public class CdcAcmSerialDriver implements UsbSerialDriver {
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        // Skysoft: add sigma zwave dongle device
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_SIGMA),
                new int[] {
                        UsbId.SIGMA_ZWAVE,
                });
