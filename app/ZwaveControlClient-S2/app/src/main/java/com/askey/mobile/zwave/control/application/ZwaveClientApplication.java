...
public  class ZwaveClientApplication extends Application {
    ...
    public static void pushActivity(Activity activity) {
        ...
        Logg.e("ZwaveClientApplication","=pushActivity=activityList:size:"+mActivitys.size());
    }

    public static void addActivity(Activity activity) {
        mActivitys.add(activity);
        Logg.e("ZwaveClientApplication","=addActivity=activityList:size:"+mActivitys.size());
    }
    ...
    public void popActivity(Activity activity) {
        ...
        Logg.e("ZwaveClientApplication","=popActivity=activityList:size:"+mActivitys.size());
    }
    ...
    public static void finishAllActivity() {
        ...
        Logg.e("ZwaveClientApplication","=finishAllActivity=mActivitys.size()"+mActivitys.size());
        for (Activity activity : mActivitys) {
            Logg.e("ZwaveClientApplication","activity.finish()");
            activity.finish();
        }
        mActivitys.clear();
    }
    ...
    public static void finishLoginActivity() {
        ...
        for (int i=0;i<mActivitys.size()-1;i++){
            ...
            Logg.e("ZwaveClientApplication","activity.finish()"+activity);
    ...
    public  static void appExit() {
        try {
            Logg.e("ZwaveClientApplication","app exit");
            finishAllActivity();
        } catch (Exception e) {
        }
    }
