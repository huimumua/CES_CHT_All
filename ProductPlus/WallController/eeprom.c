...
/*--------------------------------------------------------------------------*/
/* NVM layout WallController (as in t_nvmModule) (begin)                    */
...
uint8_t far EEOFFSET_ASSOCIATION_START_far[(NUMBER_OF_ENDPOINTS_NVM_MAX + 1) * ASSOCIATION_SIZE_NVM_MAX];
uint8_t far EEOFFSET_ASSOCIATION_MAGIC_far;
uint8_t far EEOFFSET_ASSOCIATION_ENDPOINT_START_far[(NUMBER_OF_ENDPOINTS_NVM_MAX + 1) * ASSOCIATION_SIZE_NVM_MAX];
...
uint8_t far EEOFFSET_ASSOCIATION_ENDPOINT_MAGIC_far;
EEOFFS_NETWORK_SECURITY_STRUCT far EEOFFS_SECURITY_RESERVED; //This can be remove for new sample-applications, but is placed here for backward compatibility
uint8_t far EEOFFSET_MAN_SPECIFIC_DEVICE_ID_far[MAN_DEVICE_ID_SIZE];
uint8_t far EEOFFSET_MAN_SPECIFIC_MAGIC_far;
uint8_t far EEOFFSET_TEST_NODE_ID_far;
uint8_t far EEOFFSET_TEST_POWER_LEVEL_far;
uint8_t far EEOFFSET_TEST_FRAME_COUNT_SUCCESS_far[2];
uint8_t far EEOFFSET_TEST_STATUS_far;
uint8_t far EEOFFSET_TEST_SOURCE_NODE_ID_far;
//@ [EEOFFSET_MAGIC_far]
uint8_t far EEOFFSET_MAGIC_far;
//@ [EEOFFSET_MAGIC_far]
uint8_t far EEOFFSET_CENTRAL_SCENE_SLOW_REFRESH_far;
uint8_t far EEOFFSET_MAGIC_SDK_6_70_ASSOCIATION_SECURE_far;
...
/* NVM layout WallController (as in t_nvmModule) (end)                      */
/*--------------------------------------------------------------------------*/
