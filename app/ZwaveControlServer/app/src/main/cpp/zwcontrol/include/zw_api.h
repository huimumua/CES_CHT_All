...
#define ZW_CID_SW_COLOR_SET       100    /**< zwif_sw_color_set */
#define ZW_CID_SW_COLOR_LEVEL_START    101    /**< zwif_sw_color_level_start */
#define ZW_CID_SW_COLOR_LEVEL_STOP    102    /**< zwif_sw_color_level_stop */
#define ZW_CID_NOTIFICATION_RPT_GET	     103	   /**< zwif_notification_get */
...
// Command Class Switch Color ver 1
...
int zwif_sw_color_set(zwifd_p ifd, uint8_t compid, uint8_t value);

typedef struct
{
    uint8_t     pri_dir;        /**< primary switch direction.  0 = increase level; 1 = decrease level;*/
    uint8_t     pri_ignore_lvl; /**< flag for ignoring primary switch start level.  0=use the start level as in pri_level;
                                     1=don't use the start level and instead start from the actual level in the device. */
    uint8_t     colorId;
    uint8_t     pri_level;      /**< primary switch start level */
}
zwcolor_level_t, *zwcolor_level_p;
int zwif_sw_color_level_start(zwifd_p ifd, zwcolor_level_p level_ctrl);
int zwif_sw_color_level_stop(zwifd_p ifd);
...
typedef void (*zwrep_notification_fn)(zwifd_p ifd, zwnotification_p  notification_info);
/**<
...
typedef void (*zwrep_notification_sup_fn)(zwifd_p ifd, uint8_t have_vtype, uint8_t ztype_len, uint8_t *ztype);
/**<
...
typedef void (*zwrep_notification_evt_fn)(zwifd_p ifd, uint8_t ztype, uint8_t evt_len, uint8_t *evt);
/**<
report callback for supported notification types
@param[in]	ifd	        interface
@param[in]	ztype       Z-wave notification type (ZW_NOTIFICATION_XXX)
