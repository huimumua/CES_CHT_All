...
public class APMSerialDevice extends UsbSerialDevice
{
    private static final String TAG = "====APMSerialDevice====";
    private static final String CLASS_ID = APMSerialDevice.class.getSimpleName();
    ...
    public APMSerialDevice(UsbDevice device, UsbDeviceConnection connection)
    {
        this(device, connection, -1);
    }

    public APMSerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface)
    {
        super(device, connection);
        device.getInterfaceCount();
        Log.d(TAG,"Usb Device Has " + device.getInterfaceCount() + "Interfaces");
    ...
    private boolean openAPM()
    {
        ...
        Log.i(TAG, "Endpoint Number = " + numberEndpoints);
        for(int i=0;i<=numberEndpoints-1;i++)
        {
            ...
            {
                Log.i(TAG, "Endpoint " + i + " Is InEndpoint" );
                inEndpoint = endpoint;
            }else if(endpoint.getType() == UsbConstants.USB_ENDPOINT_XFER_BULK
                    && endpoint.getDirection() == UsbConstants.USB_DIR_OUT)
            {
                Log.i(TAG, "Endpoint " + i + " Is OutEndpoint" );
        ...
        {
            Log.i(TAG, "Endpoint Not Match Spec..." );
            return false;
        }
