...
public class DoActionAdapter extends RecyclerView.Adapter<DoActionAdapter.ViewHolder> implements View.OnClickListener{

    private Context mContext;
    private List<Map<String, Object>> data;
    private RecyclerAdapter.OnItemClickListener mOnItemClickListener = null;

    public DoActionAdapter(Context context, List<Map<String, Object>> data) {
        mContext = context;
        this.data = data;
    }

    @Override
    public DoActionAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_choose_action, parent, false);
        DoActionAdapter.ViewHolder viewHolder = new DoActionAdapter.ViewHolder(view);
