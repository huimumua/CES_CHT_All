...
typedef struct
{
  char       * p_func_name;         /**< Pointer to the name of the function that this mock object covers. The function name
                                         is specified when setting up an expected call in the mock framework, as:
                                         mock_call_expect(TO_STR(<name_of_function>), &p_mock); */
  mock_type_t  expect_arg[6];       /**< Array of expected arguments which will be specified in the unit test, and validated
  ...
  mock_type_t  delta_arg[6];        /**< Array of delta values when compare rule is set to COMPARE_DELTA.
  ...
  mock_type_t  actual_arg[6];       /**< Array of the actual args. The actual parameters passed in the call to the function
  ...
  mock_type_t  output_arg[6];       /**< Array of output arguments. This array holds data to be copied as output valus in
  ...
  mock_rules_t compare_rule_arg[6]; /**< Compare rule to be used for parameter at index n.
...
#define MOCK_CALL_COMPARE_STRUCT_MEMBER(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER, TYPE) do { \
    ...
    {                                                                                                \
      ...
      case COMPARE_DELTA:                                                                            \
        ...
        break;                                                                                       \
      case COMPARE_NOT_NULL:                                                                         \
        TEST_ASSERT_NOT_NULL(RECV_POINTER);                                                          \
        break;                                                                                       \
      case COMPARE_NULL:                                                                             \
        TEST_ASSERT_NULL(RECV_POINTER);                                                              \
        break;                                                                                       \
      case COMPARE_ANY:                                                                              \
        break;                                                                                       \
    }                                                                                                \
...
#define MOCK_CALL_COMPARE_INPUT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH, TYPE) do { \
    ...
    {                                                                                                        \
      case COMPARE_STRICT:                                                                                   \
        ...
        break;                                                                                               \
      case COMPARE_NOT_NULL:                                                                                 \
        TEST_ASSERT_NOT_NULL(P_RECV_ARRAY);                                                                  \
        break;                                                                                               \
      case COMPARE_NULL:                                                                                     \
        TEST_ASSERT_NULL(P_RECV_ARRAY);                                                                      \
        break;                                                                                               \
      case COMPARE_DELTA:                                                                                    \
        TEST_FAIL_MESSAGE("Comparing delta on array is not possible in " TO_STR_MACRO(__FILE__) ":" TO_STR_MACRO(__LINE__) ); \
        break;                                                                                               \
...
#define MOCK_CALL_COMPARE_INPUT_POINTER(P_MOCK, ARGUMENT, P_RECV_VALUE) do {                \
    ...
    {                                                                                       \
      case COMPARE_STRICT:                                                                  \
        ...
        break;                                                                              \
      case COMPARE_NOT_NULL:                                                                \
        TEST_ASSERT_NOT_NULL(P_RECV_VALUE);                                                 \
        break;                                                                              \
      case COMPARE_NULL:                                                                    \
        TEST_ASSERT_NULL(P_RECV_VALUE);                                                     \
        break;                                                                              \
      case COMPARE_ANY:                                                                     \
        break;                                                                              \
      case COMPARE_DELTA:                                                                   \
...
#define N_ARGS_COUNT(_1, _2, _3, _4, _5, _6, N, ...) N
#define N_ARGS(...)                                  N_ARGS_COUNT(__VA_ARGS__, 6, 5, 4, 3, 2, 1)
