 ...
 * multicasted on the LAN backbone. The mDNS resource announcements must contain detailed i
 * nformation about the underlying node/endpoint such as its device type and supported
