...
void test_kex_including_node_state_machine_csa(void) {
  ...
  s2_context.inclusion_peer.class_id = 0x03;
  s2_inclusion_post_event(&s2_context);
  ...
  s2_context.inclusion_peer.class_id = 0x01;
  s2_inclusion_post_event(&s2_context);
  ...
  s2_context.inclusion_peer.class_id = 0x04;
  s2_inclusion_post_event(&s2_context);
...
void helper_func_echo_kex_set_frame(struct S2 *p_context)
{
  ...
  memcpy((uint8_t *)p_context->buf, s2_frame, sizeof(s2_frame));
  p_context->length = sizeof(s2_frame);
  p_context->inclusion_peer.class_id = 0x03;
}
...
void helper_func_net_key_verify_frame(struct S2 *p_context, uint8_t key)
{
  ...
  switch (key)
  {
    case 0x00:
      ...
      break;
    case 0x01:
      p_context->inclusion_peer.class_id = 0x00;
      break;
    case 0x02:
      p_context->inclusion_peer.class_id = 0x01;
      break;
    case 0x04:
      p_context->inclusion_peer.class_id = 0x02;
      break;
    case 0x80:
      p_context->inclusion_peer.class_id = 0x04;
      break;
  }
}
