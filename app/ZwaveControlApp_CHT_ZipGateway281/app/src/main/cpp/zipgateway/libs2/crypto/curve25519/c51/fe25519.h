...
void fe25519_add(fe25519_t xdata *r, const fe25519_t xdata *x, const fe25519_t xdata *y);

void fe25519_sub(fe25519_t xdata *r, const fe25519_t xdata *x, const fe25519_t xdata *y);

void fe25519_mul(fe25519_t xdata *r, const fe25519_t xdata *x, const fe25519_t xdata *y);
