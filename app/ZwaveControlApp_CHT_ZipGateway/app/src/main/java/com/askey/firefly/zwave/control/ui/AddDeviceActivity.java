...
public class AddDeviceActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initSensorfunc(int nodeId){
        ...
        if (devNodeInfo.contains("COMMAND_CLASS_SENSOR_MULTILEVEL")){
            try {
                zwaveService.getSensorMultiLevel("Zwave",nodeId);
    ...
    private void reName(String homeId ,int nodeId, String newName,String devType,String roomName) {
        zwaveService.editNodeInfo("brand",nodeId,newName,Const.zwaveType,devType,roomName,"1");
    }
    ...
    private void showStopAddDialog() {
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            timerCancel();
            if (zwaveService!=null) {
                zwaveService.stopAddDevice("Zwave");
            }
            alertDialog.dismiss();
