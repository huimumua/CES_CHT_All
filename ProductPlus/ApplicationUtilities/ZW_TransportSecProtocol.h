 ...
 * @param[in,out] pSetPowerDownTimeout Callback function pointer to a function which postpones sleep. Only
...
uint8_t Transport_OnApplicationInitSW(
    ...
    VOID_CALLBACKFUNC(pSetPowerDownTimeout)(uint8_t));
...
/**
 * Kick timeout timer for request job and response job.
 */
