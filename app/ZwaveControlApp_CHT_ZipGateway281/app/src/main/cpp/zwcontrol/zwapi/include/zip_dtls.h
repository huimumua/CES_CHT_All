/**
@file   zip_dtls.h - Z/IP host controller interface DTLS transport layer implementation  header file.
...
#ifndef _ZIP_DTLS_DAVID_
#define _ZIP_DTLS_DAVID_


/**
@defgroup DTLS DTLS Transport layer APIs
Platform specific implementation Datagram Transport Layer Security (DTLS) function.
@ingroup zwarecapi
@{
*/
...
/**<
thread for sending IPv4/IPv6 DTLS packet
...
/**<
thread to receive IPv4/IPv6 DTLS packets
@param[in]	tpt_ctx		Transport layer context
@return
*/
