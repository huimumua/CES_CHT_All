...
#ifndef _WIN32
    /* TODO: Find a win32 replacement for CLOCK_MONOTONIC_RAW */
    clock_gettime(CLOCK_MONOTONIC_RAW,&ts);
#endif
    unsigned long t = ts.tv_sec * 1000 + ts.tv_nsec / 1000000;
    scb.round_trip_first_frag = t - scb.round_trip_first_frag;
#else
