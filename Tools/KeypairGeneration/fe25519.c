...
void fe25519_add(fe25519_t *r, const fe25519_t *a, const fe25519_t *b) 
{
  uint8_t carry=0;
  uint16_t tmp;
  uint8_t i;
...
void fe25519_sub(fe25519_t *r, const fe25519_t *a, const fe25519_t *b) 
{
  uint8_t borrow;
  uint16_t tmp;
  uint8_t i;
...
void fe25519_mul(fe25519_t *r, const fe25519_t *a, const fe25519_t *b) 
{
  uint8_t t[64];
  uint16_t UV=0;
  uint8_t i;
