...
BYTE far EEOFFSET_DOOR_LOCK_MODE_far;
BYTE far EEOFFSET_DOOR_LOCK_CONDITION_far;
BYTE far EEOFFSET_HANDLES_IN_OUT_SITE_DOOR_HANDLES_STATE_far;
BYTE far EEOFFSET_LOCK_MINUTES_far;
BYTE far EEOFFSET_LOCK_SECONDS_far;
BYTE far EEOFFSET_MAGIC_far;
BYTE far EEOFFSET_LERN_MODE_far;
