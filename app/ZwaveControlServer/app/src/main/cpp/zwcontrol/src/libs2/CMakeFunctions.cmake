...
# Optional arg 0: Extenstion of runner, e.g. .cpp instead of .c
...
function(unity_test TEST )
  ...
  add_custom_command(OUTPUT ${TEST}_runner.${RUNNER_EXTENSION}
       COMMAND ${PYTHON_EXECUTABLE} ${TEST_TOOLS_DIR}/gen_test_runner.py  ${TEST}.${RUNNER_EXTENSION} > ${CMAKE_CURRENT_BINARY_DIR}/${TEST}_runner.${RUNNER_EXTENSION}
       DEPENDS ${TEST}.${RUNNER_EXTENSION} ${TEST_TOOLS_DIR}/gen_test_runner.py
